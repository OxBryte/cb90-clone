...
export default function DashboardNavbar() {
  ...
  return (
    <HStack bg='white' justify='space-between' align='center' px='30px' py='16px' w='full' boxShadow='sm' m='0'>
      <Text fontSize='20px' fontWeight='700' color='brand.100'>{pathname === '/dashboard' && 'Overview' || pathname === '/tradingbot' && 'Trading Bot' || pathname === '/alerts' && 'Alerts & Reports' || pathname === '/exchange' && 'Exchanges'}</Text>
